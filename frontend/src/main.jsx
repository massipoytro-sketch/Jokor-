...
function App() {
  ...
  const metrics = [
    ...
    ['BR POINTS', br?.ranking_points ?? player?.rank_points, Zap], ['BR K/D', br?.kd, Swords],
    ['BR WIN RATE', br?.win_rate != null ? `${br.win_rate}%` : '—', BarChart3], ['CS RANK', player?.cs_rank, Crown], ['CS POINTS', player?.cs_rank_points, Crosshair]
  ];
